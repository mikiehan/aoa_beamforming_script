#!/bin/bash
fs=48000
for chirp_dur in 12.5 25 50 75 100
do
for trial in 1 2 # # 3
do
    for inch in 60 #72 #36 # #36 #12 48 60 72 84 96 108 120 132 144 
    do
	    #fmcw_10k_15k_100_36inch_tegr0812_samedev_1_mic_48000_raw_s16le_channel_0.raw
	    #fmcw_5k_7k_100_36inch_tegr0812_sep_16000_1_mic_16000_raw_s16le_channel_0.raw
